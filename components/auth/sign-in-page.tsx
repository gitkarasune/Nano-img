            ...
            <form className="space-y-8" onSubmit={form.handleSubmit(onSubmit)}>
              <div className="grid gap-6">
                <div className="flex flex-col gap-4">
                  <Button
                    className="relative rounded-none w-full cursor-pointer"
                ...
                <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-border after:border-t">
                  <span className="relative z-10 bg-white dark:bg-black border px-2 text-muted-foreground">
                    Or continue with
                  </span>
                </div>
                <div className="grid gap-6">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <div className="flex items-center justify-between">
                            ...
                            {/* {lastMethod === "email" && (
                              <Badge className="text-[9px] rounded-full bg-white dark:bg-black border border-black dark:border-white text-black dark:text-white">last used</Badge>
                            )} */}
                          </div>
                          <FormControl>
                  ...
                  <Button className="w-full rounded-none cursor-pointer" disabled={isLoading} type="submit">
                    {isLoading ? (
